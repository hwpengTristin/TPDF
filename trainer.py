...
class Trainer(metaclass=ABCMeta):
    ...
    def prepareDataset(self):
        ...
        for phase, dataset in self.opt['datasets'].items():
            ...
            dataset['sample_window_size'] = self.opt['sample_window_size']
            dataset['num_ref'] = self.opt['num_ref']
            dataset['ref_length'] = self.opt['ref_length']
            dataset['seq_interval_frames'] = self.opt['seq_interval_frames']
